...
<!DOCTYPE html>
    ...
    <body id="page-top">
                            ...
                            <div class="col-lg-12 mb-4">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Listado de roles de Usuarios</h6>                              
                                        <button onclick="cargaSelectRoles()" class="btn btn-primary float-right" data-toggle="modal" data-target="#modalUsuarios"> Nuevo Rol de Usuario</button>                                   
                                    </div>
                                    <div class="card-body">
                            ...
                            <form id="usuarios_form">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="Detalle" class="control-label">Detalle Rol</label>
        ...
        <script src="./rolesusuario.js"></script>
    </body>
